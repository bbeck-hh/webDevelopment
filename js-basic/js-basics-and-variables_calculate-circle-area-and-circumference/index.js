...
// 1. Initialize a variable to represent the radius of the circle
let radius = 5;

// 2. Calculate the area of the circle (Fläche)
let circleArea = Math.PI * radius ** 2;

// 3. Calculate the circumference of the circle (Umfang)
let circumference = 2 * Math.PI * radius;

// 4. Display the results -> .toFixed(3) to round to 3 decimal places
console.log(`The area of the circle is: ${circleArea.toFixed(3)} and the circumference is: ${circumference.toFixed(3)}`);
